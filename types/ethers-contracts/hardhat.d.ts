...
getContractFactory(name: 'TraderCertificationNFT', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.TraderCertificationNFT__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'TraderCertificationNFT', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.TraderCertificationNFT>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'TraderCertificationNFT', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TraderCertificationNFT>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'TraderCertificationNFT', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.TraderCertificationNFT>
